...
{
    public class OP_001001 : OperationsBase, Instruction
    {
        ...
        public void LoadOperations()
        {
            ...
            Operations.Add(new OperationWrapper<(Computer Computer, int rs, int rt, int imm)>(nameof(Addiu), 32, Addiu, GetRtRsImmediateInstructions()));
        }

        static void Addiu((Computer Computer, int rs, int rt, int imm) passedArgs)
        {
