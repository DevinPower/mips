...
{
    public class OP_001100 : OperationsBase, Instruction
    {
        ...
        public void LoadOperations()
        {
            ...
            Operations.Add(new OperationWrapper<(Computer Computer, int rs, int rt, int imm)>(nameof(Andi), 32, Andi, GetRtRsImmediateInstructions()));
        }

        static void Andi((Computer Computer, int rs, int rt, int imm) passedArgs)
        {
